...
(function () {
  ...
  function printTodo(_a) {
    ...
    li.innerHTML = "<span>"
      .concat(title, " <i>by</i> <b>")
      .concat(getUserName(userId), "</b></span>");
  ...
  function removeTodo(todoId) {
    ...
    if (todoList) {
      ...
      if (todo) {
        (_a = todo.querySelector("input")) === null || _a === void 0
          ? void 0
          : _a.removeEventListener("change", handleTodoChange);
        (_b = todo.querySelector(".close")) === null || _b === void 0
          ? void 0
          : _b.removeEventListener("click", handleClose);
        todo.remove();
      }
    }
  }
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_1 = _a.sent();
            if (error_1 instanceof Error) alertError(error_1);
            return [2 /*return*/, []];
          case 4:
            return [2 /*return*/];
        }
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_2 = _a.sent();
            if (error_2 instanceof Error) alertError(error_2);
            return [2 /*return*/, []];
          case 4:
            return [2 /*return*/];
        }
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_3 = _a.sent();
            if (error_3 instanceof Error) alertError(error_3);
            return [3 /*break*/, 4];
          case 4:
            return [2 /*return*/];
        }
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch(
                "https://jsonplaceholder.typicode.com/todos/".concat(todoId),
                {
                  method: "PATCH",
          ...
          case 2:
            error_4 = _a.sent();
            if (error_4 instanceof Error) alertError(error_4);
            return [3 /*break*/, 3];
          case 3:
            return [2 /*return*/];
        }
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            error_5 = _a.sent();
            if (error_5 instanceof Error) alertError(error_5);
            return [3 /*break*/, 3];
          case 3:
            return [2 /*return*/];
        }
